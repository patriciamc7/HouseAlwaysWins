...
![Gameplay screenshot](readme/gameplay.png)
...
| Game | Description |
|------|-------------|
| Slots | Classic slot machine with randomized outcomes |
| Cara o Cruz | Coin flip with variable multipliers |
| Ruleta | Roulette with Spanish deck twist |
...
Made by [Patricia MC](https://github.com/patriciamc7)
